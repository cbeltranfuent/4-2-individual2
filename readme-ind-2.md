# actividad individual 2 modulo 4
...
Debe crear en la raiz del proyecto la carpeta `src` y la sub carpeta `js` y `css`. En la sub carpeta `js` debe estar el archivo `main.js` y En la sub carpeta `css` debe estar el archivo `style.css` , se envian los `*.svg` a la carpeta public y es neceario revisar todos los redireccionamientos para mejor preentacion y que todo este funcionando
~~~
	-src/
        |js
            |– main.js
